...
local BeginPlayHook = nil
local EndPlayHook = nil
...
local function EndHook()
    if not EndPlayHook == nil then return end

    EndPlayHook = RegisterHook("/Game/AnimX/Cats/Realistic/CharBP_Cat_R_Player.CharBP_Cat_R_Player_C:ReceiveEndPlay", function(self, EndPlayReason)
...
local function StartHook()
    if not BeginPlayHook == nil then return end

    -- Start our loop when the player has been created
    BeginPlayHook = RegisterHook("/Game/AnimX/Cats/Realistic/CharBP_Cat_R_Player.CharBP_Cat_R_Player_C:ReceiveBeginPlay", function(self)
        if not self then return end
